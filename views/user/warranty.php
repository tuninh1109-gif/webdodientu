...
if (empty($_SESSION['user'])) {
    echo '<div class="container mt-4"><p>Bạn cần đăng nhập để xem thông tin bảo hành.</p></div>';
  ...
  <div class="row">
    <div class="col-md-3 mb-3">
      <div class="list-group shadow-sm rounded-4">
        ...
        <a href="/do_dien_tu/views/user/warranty.php" class="list-group-item list-group-item-action active"><i class="bi bi-shield-check me-2"></i>Bảo hành</a>
    ...
    <div class="col-md-9">
      <div class="card p-4 shadow-sm rounded-4">
        <h3 class="mb-4"><i class="bi bi-shield-check me-2"></i>Thông tin bảo hành</h3>
        <p>Hiện tại bạn chưa có sản phẩm nào đang bảo hành.</p>
        <p class="text-muted">(Chức năng quản lý bảo hành sẽ phát triển sau)</p>
      </div>
    </div>
  </div>
</div>
